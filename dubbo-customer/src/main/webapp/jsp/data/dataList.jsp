    ...
    <div class="row">
		<div class="col-sm-12">
			<form id="listForm" name="listForm" action="#">	
			 ...
			 时间：<input type="text" onclick="WdatePicker()" id="startdate" name="startdate" value="${startdate }" class="input-text Wdate" style="width:224px;">
			 一  <input type="text" onclick="WdatePicker()" id="enddate" name="enddate" value="${enddate }" class="input-text Wdate" style="width:224px;">
