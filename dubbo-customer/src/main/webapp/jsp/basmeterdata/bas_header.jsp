...
<link rel="stylesheet" href="<%=path%>/plugins/zTree_v3/css/metroStyle/metroStyle.css" type="text/css">
    ...
    <script type="text/javascript" src="<%=path %>/plugins/layer/3.1/layer.js"></script> 
	 ...
	 <link href="<%= request.getContextPath() %>/css/h-ui/H-ui.admin.css" rel="stylesheet" type="text/css" />
     <link href="<%= request.getContextPath() %>/jslib/h-ui/Hui-iconfont/1.0.7/iconfont.css" rel="stylesheet" type="text/css" />
