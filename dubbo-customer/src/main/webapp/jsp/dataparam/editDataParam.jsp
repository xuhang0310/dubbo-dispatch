		   ...
		   $(function(){
			   ...
			   $("#form-member-edit").validate({
	                ...
	                submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form  
	                     ...
	                     var id=${dataparam.id};
	                	 var url="<%=path %>/dataparam/updateParam.do?id="+id;	                	
	   ...
	   <div class="row cl" style="display:none">
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${dataparam.SCHEDULER }" placeholder="" id="cnqname" name="cnqname"  required="required" >
	      </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">
			      <input type="text" onfocus="WdatePicker()" id="datemin" name="datemin" value="${dataparam.KSSJ }" class="input-text Wdate" style="width:224px;">
        </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">	      
				    <input type="text" onfocus="WdatePicker()" id="datemax" name="datemax"value="${ dataparam.JSSJ}" class="input-text Wdate" style="width:224px;">
	      </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${dataparam.THEORYHEATINDEX }" placeholder="" id="llrzb" name="llrzb" required="required">
	      </div>
	      <div class="col-4"> </div>
	    </div>
	     ...
	     <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${dataparam.INDESIGNTEMP }" placeholder="" id="snwd" name="snwd" required="required" >
	      </div>
	      <div class="col-4"> </div>
	    </div>
	      <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${dataparam.OUTLOWTEMP}" placeholder="" id="swwd" name="swwd" required="required" >
	      </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${dataparam.GNJSTEMP }" placeholder="" id="jswd" name="jswd" required="required" >
	      </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      <label class="form-label col-3"><span class="c-red">*</span>是否当前采暖期：</label>
	            ...
	            <select class="selectpicker"  name="cnq" id="cnq" title="请选择类型" >
		             <option value="1" <c:if test="${dataparam.CURRSCHEDULER=='1' }">selected</c:if>>是 </option>
	                 <option value="0" <c:if test="${dataparam.CURRSCHEDULER=='0' }">selected</c:if>>否</option>
	            </select>
	    </div>
	      ...
	      <div class="formControls col-5">
	        <textarea id="bz"name="bz" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="textarealength(this,100)">${dataparam.REMARK }</textarea>
