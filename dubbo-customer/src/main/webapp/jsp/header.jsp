...
<html>
  <head>
    ...
    <link href="<%=path %>/css/bootstrap.min<%=skin %>.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="<%=path %>/plugins/bootstrap_table/bootstrap-table<%=skin %>.css">
...
<link rel="stylesheet" href="<%=path%>/plugins/zTree_v3/css/metroStyle/metroStyle<%=skin %>.css" type="text/css">
		
    <script type="text/javascript" src="<%=path %>/plugins/layer/3.1/layer.js"></script> 
    
     <link href="<%= request.getContextPath() %>/css/h-ui/H-ui.min<%=skin %>.css" rel="stylesheet" type="text/css" />
	 
   
     
     <link href="<%= request.getContextPath() %>/css/ace-custome-analyse<%=skin %>.css" rel="stylesheet" type="text/css" />
...
<!-- 引入bootstrap-select结束 -->	
        ...
        <script type="text/javascript" src="<%=path %>/plugins/My97DatePicker<%=skin %>/WdatePicker.js"></script> 
<script type="text/javascript" src="<%=path %>/plugins/echart/echarts.min.js"></script>
<script type="text/javascript" src="<%=path%>/plugins/echart/echartCustom.js"></script>
<script type="text/javascript" src="<%=path%>/plugins/echart/theme/dark.js"></script>

<link rel="stylesheet" href="<%=path %>/plugins/boostrap-select-1.12.2/css/bootstrap-select.css">

 <!-- ace styles -->
<link href="<%= request.getContextPath() %>/css/ace-tab<%=skin %>.css" rel="stylesheet" type="text/css" />
...
<style>
  ...
  <input  type="hidden" id="skins" value="<%=skin%>"/>
