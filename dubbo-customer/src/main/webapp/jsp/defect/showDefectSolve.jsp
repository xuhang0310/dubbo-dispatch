	...
	<%-- 	<input type="hidden" value="${defectlist.POSITION }" name="position" id="position">			 --%>		
	   ...
	   <div class="row cl">
	 	...
	 	<label class="form-label col-2">影响民用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />换热站及范围：</label>
	      ...
	      <div class="formControls col-4">
	      <input type="text"  id="qxjssj" name="qxjssj"   value="${defectlist.ENDDEALDATE }" class="input-text Wdate" style="width:240px;"readonly="readonly">
	      </div>
	    </div>
		...
		<label class="form-label col-2">处理详情：</label>
	      <div class="formControls col-4">
	        <textarea name="dealinfo" cols="70" rows="2"  class="textarea2"   id="dealinfo" style="width: 241px;resize:none;"readonly="readonly">${defectlist.DEALINFO }</textarea>	 
	      </div>
