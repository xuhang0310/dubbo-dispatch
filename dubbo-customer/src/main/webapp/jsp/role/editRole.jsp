		   ...
		   $(function(){
			   $("#roleform").validate({
	                ...
	                submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form  
	                   ...
	                   /*    var key=$("#role_id").val(); */
	                	  var url="<%=path %>/rolemanage/saveRoleById.do";
	                	<%--   if(key!=""){
	...
	<!--    <div class="row cl" style="display:none">
	    ...
	    <div class="row cl">
	      ...
	      <div class="formControls col-5">
	        <input type="text" class="input-text" value="${role.rolename }" placeholder="" id="member-name" name="displayname"  required >
	      </div>
	      <div class="col-4"> </div>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <div class="col-4"> </div> -->
	      	<select class="selectpicker" data-live-search="true"  name="tablename" id="tablename" title="请选择机构" >
		    	<c:forEach var="o" items="${org}">
			            		<option value="${o.orgid}" <c:if test="${o.orgid==role.orgid}">selected</c:if>>${o.orgname}</option>
			            </c:forEach>        
	        </select>
	    </div>
	    ...
	    <div class="row cl">
	      ...
	      <!-- placeholder="说点什么...最少输入10个字符"  onKeyUp="textarealength(this,100)"-->
	        <textarea name="bz" cols="" rows="" value="${role.NOTE}" class="textarea"   id="bz"></textarea>
