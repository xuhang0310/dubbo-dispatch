...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
            	var iconClass = "";
            	if($(box).attr("iconClass")){
            		iconClass = $(box).attr("iconClass");
            	}
                var header = $('<div class="l-accordion-header"><div class="l-accordion-toggle"></div><div class="l-accordion-header-inner '+iconClass+'"></div></div>');
                if (i == selectedIndex)
        ...
        setHeight: function (height)
        {
            ...
            $("> .l-accordion-content", g.accordion).height(height - 8);
        }
    });
    ...
    $.ligerui.controls.Tab.ligerExtend($.ligerui.core.UIComponent, {
        ...
        toggleSwitch: function (btn)
        {
            ...
            windowsswitch.css({
                ...
                left: $(btn).offset().left - windowsswitch.width() + 22
            });
