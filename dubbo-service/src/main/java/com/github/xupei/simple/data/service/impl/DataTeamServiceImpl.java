...
public class DataTeamServiceImpl extends GridSqlUtilTool implements IDataTeamService{
	...
	public String getSql(Map<String, String> paramMap){
		...
		String sql="SELECT T.TEAMID,T.TEAMID as CODE,S.ORGNAME as PARENTORG,S.ORGID,T.SCHEDULERNAME,t.PrincipalDis PRINCIPAL,t.watchname WATCH,t.program FROM data_scheduler_team T,sys_org S" +
				" WHERE T.PARENTORG=S.ORGID and T.PARENTORG in (SELECT ORGID FROM SYS_USER WHERE 1=1 [and USERNAME IN ('{LoginName}') ] )";
	 ...
	 */
	@Override
	public void saveDataTeam(Map<String, String> paramMap) throws Exception {
		// TODO Auto-generated method stub
